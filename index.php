...
<link rel="apple-touch-startup-image" 
	...
	href="image/startup_ipad_portrait.jpg"/>																							<!-- Choisir une image de chargement (768*1004, orientation portrait, pour iPad) -->																							<!-- Choisir une image de chargement (1024*764, orientation paysage, pour iPad) -->
...
<div id="logo"><a href="internet.php"><img alt="internet" src="image/logo_internet_mini.png"/></a><a href="index.php"><img alt="internet" src="image/logo_book.png"/></a><a href="evenementiel.php"><img alt="internet" src="image/logo_evenementiel_mini.png"/></a></div>
			...
			<ul id="thelist">
				<?php
					...
					while($res2 = mysql_fetch_array($req2))
					{
						...
						echo "\t\t\t"."<li><a href='./clients.php?num=".$res2[IDNiv2]."'  title='".$req2['Libelle']."'>";
