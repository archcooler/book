...
<div id="logo"><a href="index.php"><img alt="internet" src="image/logo_book_mini.png"/></a><a href="internet.php"><img alt="internet" src="image/logo_internet.png"/></a><a href="evenementiel.php"><img alt="internet" src="image/logo_evenementiel_mini.png"/></a></div>
<div name="mon_menu" class="menu">
<div id="wrapper">
		<div id="scroller">
			<ul id="thelist">
				<?php
					//-------------------------- Affichage des items pour le menu (les catégories des produits internet) ---------------------------
					$sql2 = "SELECT * FROM niv4 WHERE IDNiv3=77 ORDER BY Ordre";
					...
					while($res2 = mysql_fetch_array($req2))
					{
						...
						if($nbClientTot>0){
							echo "\t\t\t"."<li><a href='./bestof.php?num=".$res2[IDNiv4]."&cat=internet'  title='".utf8_decode($res2['Libelle'])."'>";
